...
\newcommand{\UseTitleFont}{\UseHeadingFont\fontsize{20pt}{33.6pt}\selectfont\bfseries}
...
\newcommand{\SubBulletSymbolBullet}{{\normalfont\fontsize{6}{7.2}\selectfont\raisebox{0.17em}{\char"25CF}\textbullet}}
...
\newcommand{\SubBulletItemBullet}{\par%
\savebox{\SubBulletItemIndentation}{\hspace{6.8mm}\SubBulletSymbolBullet\hspace{.6mm}}%
\settowidth{\SubBulletItemIndentationWidth}{\usebox{\SubBulletItemIndentation}}%
\noindent\hangafter=1\hangindent=\SubBulletItemIndentationWidth\ignorespaces%
\usebox{\SubBulletItemIndentation}\ignorespaces}
